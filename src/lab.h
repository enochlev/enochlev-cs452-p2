...
#define BLOCK_UNUSED   3  /*Block is not used at all*/
  ...
  /**
   * Prints the current state of the buddy memory system to the terminal.
   * Indentation is used to represent the size hierarchy of the memory blocks.
   * Each block is labeled with its state: UNUSED, AVAIL, RESERVED.
   *
   * @param pool The memory pool to print.
   */
